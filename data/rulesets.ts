...
export const Rulesets: import('../sim/dex-formats').FormatDataTable = {
	...
	flatrules: {
		...
		ruleset: ['Team Preview', 'Species Clause', 'Nickname Clause', 'Beat Up Nicknames Mod', 'Item Clause = 1', 'Adjust Level Down = 50', 'Picked Team Size = Auto', 'Cancel Mod'],
	...
	onemegaorteraclause: {
		...
		onBegin() {
			this.add('rule', 'One Mega or Tera Clause: Each team may Mega Evolve or Terastallize once, but not both');
		},
		onAfterMega(pokemon) {
